...
1. After cloning the project, switch to `terraform` folder, update the subscription ID in manifest and use `terraform init`, `terraform plan` (recommended) and `terraform apply`.
